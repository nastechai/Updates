...
**The native desktop app for [NasTech Agent](../../README.md) — the self-improving AI agent from [NasTech](https://nastechairesearch.com).** Same agent, same skills, same memory as the CLI and gateway, in a polished native window — chat with streaming tool output, side-by-side previews, a file browser, voice, and settings, no terminal required. Available for **macOS, Windows, and Linux**.
...
4. `NASTECH_DESKTOP_HERMES`, or `nastech` on `PATH`
...
Built by [NasTech](https://nastechairesearch.com).
