...
_NASTECH_MD_NAMES = (".nastech.md", "HERMES.md")


def _find_nastech_md(cwd: Path) -> Optional[Path]:
    """Discover the nearest ``.nastech.md`` or ``HERMES.md``.
...
def _load_nastech_md(cwd_path: Path, context_length: Optional[int] = None) -> str:
    """.nastech.md / HERMES.md — walk to git root."""
...
def build_context_files_prompt(
    ...
    Priority (first found wins — only ONE project context type is loaded):
      1. .nastech.md / HERMES.md  (walk to git root)
