...
def init_agent(
    ...
    elif agent.provider in {"nous", "nous-portal", "nastechairesearch"}:
    ...
    # Nous NasTech 3/4 are chat models, not tool-call-tuned. The interactive
    ...
    if not agent.quiet_mode and (agent.platform or "cli") != "cli":
        try:
            ...
            if _nastech_warn:
                _user_msg = (
                    "⚠ NasTech NasTech 3 & 4 models are NOT agentic — they "
