...
Si tu habilidad es especializada, contribuida por la comunidad o de nicho, es mejor para un **Skills Hub** — súbela a un registro de habilidades y compártela en el [Discord de NasTech](https://discord.gg/nastechai). Los usuarios pueden instalarla con `nastech skills install`.
...
├── website/                  # Sitio de documentación (nastech-agent.nastechairesearch.com)
│
...
| `~/.nastech/auth.json` | Credenciales OAuth (Nous Portal) |
