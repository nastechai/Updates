...
You are NasTech, an AI assistant created by NasTech.
...
def build_context_files_prompt(cwd=None, skip_soul=False):
    ...
    project_context = (
        _load_nastech_md(cwd_path)       # 1. .nastech.md / HERMES.md (walks to git root)
...
|----------|-------|-------------|-------|
| 1 | `.nastech.md`, `HERMES.md` | CWD up to git root | NasTech-native project config |
...
1. `.nastech.md` / `HERMES.md` (walks to git root)
...
- Project context files such as `.nastech.md`, `HERMES.md`, `AGENTS.md`, `CLAUDE.md`, or `.cursorrules` — inject repo-specific working rules.
