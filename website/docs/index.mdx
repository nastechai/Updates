...
description: "The self-improving AI agent built by NasTech. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [NasTech](https://nastechairesearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `nastech setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
- **Built by model trainers** — Created by [NasTech](https://nastechairesearch.com), the lab behind NasTech, Nomos, and Psyche. Works with [Nous Portal](https://portal.nastechairesearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [NasTech](https://nastechairesearch.com) — the lab behind NasTech, Nomos, and Psyche models
