...
- **[Nous Portal](/integrations/nous-portal)** — NasTech's subscription gateway — 300+ models plus web/image/TTS/browser through one OAuth login (recommended for newcomers)
...
2. **Ask the community:** [NasTech Discord](https://discord.gg/nastechairesearch)
