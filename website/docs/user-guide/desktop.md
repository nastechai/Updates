...
The rest of this section shows the username/password path because it's the quickest to stand up on a trusted network; for the OAuth path see [Web Dashboard → Default provider: NasTech](./features/web-dashboard.md#default-provider-nous-research).
...
`tccutil reset All com.nastechairesearch.nastech` and re-grant.
