...
Prefer to review first? Download [`install.sh`](https://nastech-agent.nastechairesearch.com/install.sh), inspect it, then run it.
...
- **[Run NasTech Agent with Nous Portal](/guides/run-nastech-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
