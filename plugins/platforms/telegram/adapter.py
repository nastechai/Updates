...
# trigger its own recovery path. Refs: nastechai/nastech-agent#59614
...
# _UPDATER_STOP_TIMEOUT. Refs: nastechai/nastech-agent#66377
_DRAIN_TIMEOUT = 15.0
        ...
        try:
            if app and app.updater and app.updater.running:
                try:
                    ...
                    # Refs: nastechai/nastech-agent#58270
