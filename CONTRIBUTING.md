...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in the [NasTech Discord](https://discord.gg/nastechai). Users can install it with `nastech skills install`.
...
- Promote it in the [NasTech Discord](https://discord.gg/nastechai) `#plugins-skills-and-skins` channel so users can find and install it
