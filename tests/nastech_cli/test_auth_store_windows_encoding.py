...
class TestAuthJsonSiblingReaders:
    ...
    def test_auxiliary_nous_provider_reads_non_ascii_store(self, nastech_home, windows_default_encoding, monkeypatch):
    ...
    def test_read_shared_nous_state_reads_non_ascii_store(
        ...
        """nastech_cli.auth._read_shared_nous_state must read a non-ASCII store.
