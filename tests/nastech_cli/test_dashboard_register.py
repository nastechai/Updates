...
class TestHappyPath:
    def _run(self, *, args, account_token="tok_abc", portal="https://portal.nastechairesearch.com",
...
class TestPortalResolution:
    ...
    def test_falls_back_to_stored_login_portal(self):
        with patch(
            ...
            return_value={"portal_base_url": "https://portal.staging-nastechairesearch.com"},
        ):
            assert (
                dr._resolve_portal_base_url(None)
                == "https://portal.staging-nastechairesearch.com"
            )
...
class TestPortalErrors:
    def _run_http_error(self, code, body):
        err = urllib.error.HTTPError(
            url="https://portal.nastechairesearch.com/api/oauth/self-hosted-client",
            code=code,
            msg="err",
            hdrs=None,
