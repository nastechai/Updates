...
class TestWebServerEndpoints:
    ...
    def test_update_nastech_returns_docker_guidance_without_spawning(self, monkeypatch):
        ...
        assert "docker pull nastechairesearch/nastech-agent:latest" in data["message"]
        ...
        assert any("docker pull nastechairesearch/nastech-agent:latest" in line for line in status_data["lines"])
