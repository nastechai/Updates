...
def test_fresh_account_payload_normalization(monkeypatch, payload, expected_paid):
    ...
    monkeypatch.setattr("nastech_cli.auth.resolve_nous_access_token", lambda: "fresh-token")
    monkeypatch.setattr("nastech_cli.nous_account._fetch_nous_account_info", lambda *a, **kw: payload)
