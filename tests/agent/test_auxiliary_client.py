                    ...
                    "moa": {
                        ...
                        "presets": {
                            ...
                            "nous-mix": {
                                "enabled": True,
                                "reference_models": [
                                    {"provider": "nous", "model": "nastech-4-70b"}
                                ],
                                "aggregator": {
                                    "provider": "nous",
...
class TestBuildCallKwargsMaxTokens:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("nous", "nastech-4", "https://inference-api.nastechairesearch.com/v1", "max_tokens"),
        ],
    )
...
class TestAuxiliaryPoolAwareness:
    ...
    def test_call_llm_retries_nous_after_401(self):
        ...
        with (
            ...
            patch("agent.auxiliary_client._resolve_nous_runtime_api", return_value=("fresh-agent-key", "https://inference-api.nastechairesearch.com/v1")),
        ):
            result = call_llm(
                task="compression",
                messages=[{"role": "user", "content": "hi"}],
...
class TestRefreshNousRecommendedModel:
    ...
    def test_falls_back_to_default_when_portal_unavailable(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "nastech_cli.models.get_nous_recommended_aux_model", _boom)
    ...
    def test_returns_none_when_no_distinct_alternative(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "nastech_cli.models.get_nous_recommended_aux_model",
...
class TestAuxiliaryClientPoisonedCacheEviction:
    ...
    See https://github.com/nastechai/nastech-agent/issues/23432.
    """
...
class TestBuildCallKwargsToolDedup:
    ...
    regresses.  See: https://github.com/nastechai/nastech-agent/issues/18478
    """
