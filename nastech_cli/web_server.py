...
async def get_status(profile: Optional[str] = None):
    ...
    try:
        ...
        try:
            from nastech_cli.auth import get_nous_session_validity
...
def _apply_model_assignment_sync(
    ...
    if scope == "main":
        ...
        if provider.strip().lower() == "nous":
            try:
                from nastech_cli.nous_subscription import apply_nous_managed_defaults
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "email": {
        ...
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/",
        "env_vars": (
            "EMAIL_ADDRESS",
            "EMAIL_PASSWORD",
            "EMAIL_IMAP_HOST",
    ...
    "google_chat": {
        ...
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/google_chat",
    },
    "wecom": {
    ...
    "weixin": {
        ...
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/weixin/",
    ...
    "teams": {
        ...
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/teams",
    },
    ...
    "irc": {
        ...
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/irc",
    },
    "line": {
        "description": "Use NasTech from LINE via the LINE Messaging API webhook.",
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/line",
    },
    "ntfy": {
        "description": "Chat with NasTech over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/ntfy",
    },
    "photon": {
        "description": "Use NasTech through iMessage via Photon's managed Spectrum platform.",
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/photon",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/raft",
    },
    "simplex": {
        "description": "Talk to NasTech over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/simplex",
    },
    "yuanbao": {
        "name": "Yuanbao (元宝)",
    ...
    "webhook": {
        ...
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/webhooks/",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/msgraph-webhook",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use NasTech via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging/whatsapp-cloud",
    },
    "relay": {
...
_TELEGRAM_ONBOARDING_DEFAULT_URL = "https://setup.nastech-agent.nastechairesearch.com"
...
_OAUTH_PROVIDER_CATALOG: tuple[Dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "docs_url": "https://nastech-agent.nastechairesearch.com/docs/guides/xai-grok-oauth",
...
async def disconnect_oauth_provider(
    ...
    def _run():
        with _profile_scope(profile):
            ...
            try:
                from nastech_cli.auth import clear_provider_auth, invalidate_nous_auth_status_cache
...
def start_server(
    ...
    try:
        from nastech_cli.nous_auth_keepalive import start_nous_auth_keepalive
    ...
    if app.state.auth_required:
        ...
        if not list_providers():
            ...
            _fix_hint = (
                ...
                "  • OAuth: run `nastech dashboard register` (Nous Portal) or "
