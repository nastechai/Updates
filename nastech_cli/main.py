...
def _maybe_setup_dashboard_auth_interactively(args) -> None:
    ...
    print("    [2] OAuth via Nous Portal (run `nastech dashboard register`)")
    print("    [3] Cancel")
    print()
...
def main():
    ...
    fallback_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://nastech-agent.nastechairesearch.com/docs/user-guide/features/fallback-providers"
        ),
    )
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://nastech-agent.nastechairesearch.com/docs/user-guide/secrets/"
        ),
    )
    ...
    egress_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://nastech-agent.nastechairesearch.com/docs/user-guide/egress/iron-proxy"
        ),
    )
